...
CREATE TABLE public.aira_interview_sessions (
...
CREATE TABLE public.aira_conversations (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
...
CREATE TABLE public.aira_analytics (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  session_id UUID NOT NULL REFERENCES public.aira_interview_sessions(id) ON DELETE CASCADE,
...
CREATE TABLE public.aira_activities (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  session_id UUID NOT NULL REFERENCES public.aira_interview_sessions(id) ON DELETE CASCADE,
...
CREATE TABLE public.aira_code_snippets (
  id UUID NOT NULL DEFAULT gen_random_uuid() PRIMARY KEY,
  session_id UUID NOT NULL REFERENCES public.aira_interview_sessions(id) ON DELETE CASCADE,
...
CREATE INDEX idx_aira_sessions_user_id ON public.aira_interview_sessions(user_id);
CREATE INDEX idx_aira_conversations_session_id ON public.aira_conversations(session_id);
CREATE INDEX idx_aira_analytics_session_id ON public.aira_analytics(session_id);
CREATE INDEX idx_aira_activities_session_id ON public.aira_activities(session_id);
CREATE INDEX idx_aira_code_snippets_session_id ON public.aira_code_snippets(session_id);
